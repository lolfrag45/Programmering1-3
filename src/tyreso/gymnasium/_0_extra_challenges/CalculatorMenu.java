...
public class CalculatorMenu
{
    public static void main(String[] args)
    {
        ...
        BigDecimal num1 = new BigDecimal(scanObject.nextInt());
        System.out.println("Please enter second number: ");
        BigDecimal num2 = new BigDecimal(scanObject.nextInt());
        ...
        operator = scanObject.next().charAt(0);
            ...
            switch (operator) {
                case '+':
                    ...
                    answer = calculator.addition(num1, num2);             //Builds a switch statement
                    break;
                case '-':
                ...
                case '*':
                    ...
                    break;
                case '/':
                    answer = calculator.divition(num1, num2);
                    //System.out.println("in '/' switch statement");
                    break;
                case '^':
                    int tmpNum2 = num2.intValue();
                    answer = calculator.power(num1, tmpNum2);
                    break;
            }
